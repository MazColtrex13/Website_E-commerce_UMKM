...
@section('content')
    <div class="px-4 md:px-16">
        <div class="pl-2 mt-5 border-l-4 border-yellow-500">
            <h1 class="text-2xl text-[#9a031fdd] font-bold">Keranjang Saya</h1>
            <p class="text-gray-600">Menu di Keranjang</p>
        </div>
        ...
        <div class="mt-5 overflow-x-auto">
            <table class="min-w-full bg-white rounded-lg shadow-md">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="p-4 text-left border-b border-gray-300">Gambar Menu</th>
                        <th class="p-4 text-left border-b border-gray-300">Nama Menu</th>
                            ...
                            <td class="p-2 border-b border-gray-100">
                                <div class="flex justify-center space-x-2">
                                    <a href="{{ route('checkout', $cart->id) }}"
                                        class="px-3 py-1 text-white transition bg-yellow-600 rounded-lg ">Pesan Pembayaran</a>
