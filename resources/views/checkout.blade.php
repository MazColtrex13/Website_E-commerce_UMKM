    ...
    <div class="container py-10 mx-auto">
        ...
        <div class="grid max-w-4xl mx-auto bg-white rounded-lg shadow-lg lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-2">
            ...
            <div class="p-5 mb-6 bg-white rounded-lg shadow-md">
                <h3 class="text-xl font-semibold underline mb-10 text-center text-[#9a031fdd]">Informasi Menu</h3>
                <p><strong>Gambar Menu:</strong>
                    <img src="{{ asset('images/products/' . $cart->product->photopath) }}" alt="{{ $cart->product->name }}"
                        class="h-24 mx-auto">
                </p>

                <p><strong>Nama:</strong> {{ $cart->product->name }}</p>
                <p><strong>Quantity:</strong> {{ $cart->qty }}</p>


                <p><strong>Diskon Menu:</strong> <span
                        class="text-[#9a031fdd]">Rp {{ number_format($cart->product->discounted_price, 2) }}</span> </p>
                <p><strong>TotalHarga:</strong> Rp {{ number_format($cart->total, 2) }}</p>





                <p><strong>Deskripsi:</strong> {{ $cart->product->description }}</p>
            ...
            <div class="flex flex-col justify-center p-8 rounded-r-lg bg-gray-50">
                ...
                <div class="p-5 mb-6 bg-white rounded-lg shadow-md">
                    <h3 class="flex items-center mb-4 text-xl font-semibold text-yellow-600">
                        <i class="mr-2 text-2xl bx bx-package"></i> Pembayaran Tunai Saat Pengiriman
                    </h3>
                ...
                <div class="p-5 bg-white rounded-lg shadow-md">
                    <h3 class="flex items-center mb-4 text-xl font-semibold text-[#039a05ed]">
                        <i class="mr-2 text-2xl bx bx-wallet"></i> Bayar dengan eSewa
                    </h3>
