...
@section('content')
    <div class="flex flex-col w-full max-h-screen p-6 overflow-y-auto">
        ...
        <div class="flex items-center justify-around w-full mt-2 lg:justify-between">
            <span class="text-3xl font-semibold ml-5  text-[#9a031f] lg:font-bold lg:text-4xl">Menu
            </span>
        ...
        <form action="{{ route('product.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
            ...
            {{-- Product Type Input --}}
            <div>
                <label for="product_type" class="block text-sm font-medium text-gray-700">Jenis Menu</label>
            ...
            <div>
                <label for="discounted_price" class="block text-sm font-medium text-gray-700">Diskon Menu</label>
            ...
            <div class="flex justify-center mt-4 space-x-4">
                <button type="submit" class="px-4 py-2 text-white bg-blue-500 rounded-lg">Buat Menu</button>
                <a href="{{ route('product.index') }}" class="px-4 py-2 text-white bg-red-500 rounded-lg">Keluar</a>
            </div>
        </form>
    </div>
@endsection
