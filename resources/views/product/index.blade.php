...
@section('content')
    <div class="flex flex-col w-full max-h-screen overflow-y-auto">
        ...
        <div class="flex items-center justify-around w-full mt-2 lg:justify-between">
            ...
            <a href="{{ route('product.create') }}" class="px-3 py-1 text-white bg-yellow-500 rounded-lg">Tambah</a>
        </div>
                                ...
                                <td class="p-2 border">
                                    <div class="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2">
                                        ...
                                        <a href="{{ route('product.destroy', $product->id) }}"
                                            ...
                                            onclick="return confirm('Are you sure to Delete?')">Keluar</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
